...
![Instalación MariaDB 1](/assets/images/iissi2/lab1-0/mariadb_install_1.png)
...
![Instalación MariaDB 2](/assets/images/iissi2/lab1-0/mariadb_install_2.png)
...
![HeidiSQL sesión 2](/assets/images/iissi2/lab1-0/hs-2.png)
...
![HeidiSQL sesión 3](/assets/images/iissi2/lab1-0/hs-3.png)
...
![Administrador de usuarios](/assets/images/iissi2/lab1-0/adminUsuarios.png)

Pulsamos en ![Agregar usuario](/assets/images/iissi2/lab1-0/agregarUsuario.png) y creamos un nuevo usuario con nombre `iissi_user` y clave `iissi$user`. En "Desde el host" se deja marcado "localhost", lo cual indica que el usuario a crear sólo podrá ser accedido desde nuestra máquina, no por conexiones remotas.

En la parte inferior podremos asignarle permisos al usuario que vamos a crear. Es aconsejable otorgar los mínimos permisos imprescindibles, por lo que el nuevo usuario sólo tendrá permisos para modificar la base de datos "grados". Para otorgarle permisos en la BD que acabamos de crear, la seleccionamos en ![Agregar objeto](/assets/images/iissi2/lab1-0/agregarObjeto.png) y marcamos todos los permisos.

![Crear usuario](/assets/images/iissi2/lab1-0/crearUsuario.png)
...
![HeidiSQL sesión 6](/assets/images/iissi2/lab1-0/hs-6.png)

En esta sesión sólo se tiene acceso a las BD del usuario, no a las del sistema:

![HeidiSQL sesión 7](/assets/images/iissi2/lab1-0/hs-7.png)
...
![Consulta asignaturas](/assets/images/iissi2/lab1-0/hs-8.png)
...
![Instalación Python](/assets/images/iissi2/lab1-0/python.png)

Entre las opciones de instalación opcionales, **dejamos marcadas todas las opciones**:

![Opciones Python](/assets/images/iissi2/lab1-0/python-opt.png)

Marcamos las siguientes opciones avanzadas:

![Opciones avanzadas Python](/assets/images/iissi2/lab1-0/python-opt-2.png)
...
![Comprobar Python](/assets/images/iissi2/lab1-0/pycheck.png)
...
![Comprobar pip](/assets/images/iissi2/lab1-0/pipcheck.png)
...
![VS Code](/assets/images/iissi2/lab1-0/VSC.png)
...
![VS Code Python](/assets/images/iissi2/lab1-0/VSC-python.png)
...
![VS Code REST Client](/assets/images/iissi2/lab1-0/VSC-REST.png)
