...
toc_sticky: true
pdf_version: true
title: "Anexo - Entorno de trabajo"
nav_order: 10
---
...
![Instalación MariaDB 1]({{ '/assets/images/iissi2/lab1-0/mariadb_install_1.png' | relative_url }})
...
![Instalación MariaDB 2]({{ '/assets/images/iissi2/lab1-0/mariadb_install_2.png' | relative_url }})
...
![HeidiSQL sesión 2]({{ '/assets/images/iissi2/lab1-0/hs-2.png' | relative_url }})
...
![HeidiSQL sesión 3]({{ '/assets/images/iissi2/lab1-0/hs-3.png' | relative_url }})
...
![Crear database]({{ '/assets/images/iissi2/lab1-0/crearDatabase.png' | relative_url }})

Si pulsamos sobre la conexión y la actualizamos mediante **F5**, podremos ver que se ha creado la base de datos "grados":

![Grados creada]({{ '/assets/images/iissi2/lab1-0/grados.png' | relative_url }})
...
![Administrador de usuarios]({{ '/assets/images/iissi2/lab1-0/adminUsuarios.png' | relative_url }})

Pulsamos en ![Agregar usuario]({{ '/assets/images/iissi2/lab1-0/agregarUsuario.png' | relative_url }}) y creamos un nuevo usuario con nombre `iissi_user` y clave `iissi$user`. En "Desde el host" se deja marcado "localhost", lo cual indica que el usuario a crear sólo podrá ser accedido desde nuestra máquina, no por conexiones remotas.

En la parte inferior podremos asignarle permisos al usuario que vamos a crear. Es aconsejable otorgar los mínimos permisos imprescindibles, por lo que el nuevo usuario sólo tendrá permisos para modificar la base de datos "grados". Para otorgarle permisos en la BD que acabamos de crear, la seleccionamos en ![Agregar objeto]({{ '/assets/images/iissi2/lab1-0/agregarObjeto.png' | relative_url }}) y marcamos todos los permisos.

![Crear usuario]({{ '/assets/images/iissi2/lab1-0/crearUsuario.png' | relative_url }})
...
![HeidiSQL sesión 6]({{ '/assets/images/iissi2/lab1-0/hs-6.png' | relative_url }})

En esta sesión sólo se tiene acceso a las BD del usuario, no a las del sistema:

![HeidiSQL sesión 7]({{ '/assets/images/iissi2/lab1-0/hs-7.png' | relative_url }})
...
![Consulta asignaturas]({{ '/assets/images/iissi2/lab1-0/hs-8.png' | relative_url }})
...
![Instalación Python]({{ '/assets/images/iissi2/lab1-0/python.png' | relative_url }})

Entre las opciones de instalación opcionales, **dejamos marcadas todas las opciones**:

![Opciones Python]({{ '/assets/images/iissi2/lab1-0/python-opt.png' | relative_url }})

Marcamos las siguientes opciones avanzadas:

![Opciones avanzadas Python]({{ '/assets/images/iissi2/lab1-0/python-opt-2.png' | relative_url }})
...
![Comprobar Python]({{ '/assets/images/iissi2/lab1-0/pycheck.png' | relative_url }})
...
![Comprobar pip]({{ '/assets/images/iissi2/lab1-0/pipcheck.png' | relative_url }})
...
![VS Code]({{ '/assets/images/iissi2/lab1-0/VSC.png' | relative_url }})
...
![VS Code Python]({{ '/assets/images/iissi2/lab1-0/VSC-python.png' | relative_url }})
...
![VS Code REST Client]({{ '/assets/images/iissi2/lab1-0/VSC-REST.png' | relative_url }})
