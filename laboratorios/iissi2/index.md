...
- **[Lab2-1 - HTML básico](./lab2-1/)**: Fundamentos de HTML, estructura de páginas web y elementos básicos
- **[Lab2-2 - Hojas de estilo (CSS)](./lab2-2/)**: Introducción a CSS, selectores, propiedades y diseño visual
- **[Lab2-3 - CSS avanzado (Bootstrap)](./lab2-3/)**: Framework Bootstrap para diseño responsivo y componentes UI
- **[Lab2-4 - JavaScript (Básico)](./lab2-4/)**: Programación básica en JavaScript, variables, funciones y DOM
- **[Lab2-5 - JavaScript (Renderizado y JSON)](./lab2-5/)**: Manipulación avanzada del DOM y trabajo con datos JSON
- **[Lab2-6 - Peticiones AJAX GET](./lab2-6/)**: Comunicación asíncrona con APIs REST usando JavaScript
- **[Lab2-7 - Peticiones AJAX POST](./lab2-7/)**: Envío de datos al servidor mediante peticiones POST
- **[Lab2-8 - Gestión de sesiones](./lab2-8/)**: Autenticación, autorización y manejo de sesiones de usuario

### Anexos

- **[Anexo - Entorno de trabajo](./anexo-entorno/)**: Configuración del entorno de desarrollo, instalación de MariaDB, Python y herramientas necesarias
