...
## Modelo Relacional. Versión 2: una relación por cada entidad
...
```mr-table
Resultado = { vid, mar, mod, año, cla, pue, tra, cil, man }
...
$$cilPromedio \leftarrow \Group{\rho_{cilindradaMedia}(AVG(cil))}{}(Motos)$$

```mr-table
Resultado = { cilindradaMedia }
...
$$añoMin \leftarrow \Group{\rho_{añoMin}(MIN(año))}{}(Coches)$$
...
$$ V - \Proj{vid,mar,mod,año}(V \NatJoin C) - \Proj{vid,mar,mod,año}(V \NatJoin M)$$

**4. Obtener la marca y modelo de todas las motos con cilindrada mayor a 800cc**

$$\Proj{mar, mod}(\Sel{cil > 800}(V \NatJoin M))$$

**5. Obtener todos los coches con transmisión automática**

$$\Sel{tra = 'Automática'}(V \NatJoin C)$$
...
$$cilPromedio \leftarrow \Group{\rho_{cilindradaMedia}(AVG(cil))}{}(M)$$

**8. Obtener el coche más antiguo**

$$añoMin \leftarrow \Group{\rho_{añoMin}(MIN(año))}{}(C)$$

$$\Sel{año = añoMin}(V \NatJoin C)$$

**9. Obtener todas las marcas que fabrican tanto coches como motos**

$$\Proj{mar}(V \NatJoin C \NatJoin M) $$
