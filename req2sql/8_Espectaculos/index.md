...
{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Espectaculos/sql/createDB.sql' label='Espectaculos/createDB.sql' collapsed=true %}

## Script SQL para la carga inicial de datos

Para cargar los datos de prueba se puede usar el siguiente script:

{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Espectaculos/sql/populateDB.sql' label='Espectaculos/populateDB.sql' collapsed=true %}

## Consultas

Para crear las consultas SQL de las expresiones en Álgebra relacional se puede usar el siguiente script:

{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Espectaculos/sql/queries.sql' label='Espectaculos/queries.sql' collapsed=true %}
