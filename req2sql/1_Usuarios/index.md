...
![Diagrama de objetos]({{ '/assets/images/iissi1/req2sql/Usuarios/usuarios-do.png' | relative_url }})
...
{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Usuarios/sql/createDB.sql' label='Usuarios/createDB.sql'  collapsed=true %}

### Script SQL para la carga inicial de datos

Para cargar los datos de prueba se puede usar el siguiente script:

{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Usuarios/sql/populateDB.sql' label='Usuarios/populateDB.sql'  collapsed=true %}

### Consultas

Para crear las consultas que implementan los requisitos funcionales se puede usar el siguiente script:

{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Usuarios/sql/queries.sql' label='Usuarios/queries.sql'  collapsed=true %}
...
{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Usuarios/sql/fGetAge.sql' label='Usuarios/fGetAge.sql'  collapsed=true %}

El script para el trigger es el siguiente:

{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Usuarios/sql/tCheckAge.sql' label='Usuarios/tCheckAge.sql'  collapsed=true %}
...
{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/Usuarios/sql/version2.sql' label='Usuarios/version2.sql'  collapsed=true %}


<!-- Ahora el script para la creación de la tabla es el siguiente:

{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/_sql/_Usuarios2/createDB.sql' label='Usuarios2/createDB.sql'  collapsed=true %}

Los datos de prueba son los mismos que en el caso anterior pero sustituyendo la fecha de nacimiento por la edad:

{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/_sql/_Usuarios2/populateDB.sql' label='Usuarios2/populateDB.sql'  collapsed=true %}
...
{% include sql-embed.html src='/assets/DB-Silence-IISSI-1/_sql/_Usuarios2/queries.sql' label='Usuarios2/queries.sql'  collapsed=true %}
